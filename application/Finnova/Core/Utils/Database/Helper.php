...
namespace Finnova\Core\Utils\Database;
...
class Helper
{
    ...
    protected $drivers = array(
        'mysqli' => '\Finnova\Core\Utils\Database\DBAL\Driver\Mysqli\Driver',
        'pdo_mysql' => '\Finnova\Core\Utils\Database\DBAL\Driver\PDOMySql\Driver',
    );

    public function __construct(\Finnova\Core\Utils\Config $config = null)
    {
        $this->config = $config;
    }
