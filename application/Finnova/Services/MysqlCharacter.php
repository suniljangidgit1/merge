...
class MysqlCharacter extends \Finnova\Core\Services\Base
{
    ...
    public function jobConvertToMb4()
    {
        ...
        foreach ($ormMeta as $entityName => $entityParams) {
            ...
            $tableName = \Finnova\Core\Utils\Util::toUnderScore($entityName);
            ...
            foreach ($entityParams['fields'] as $fieldName => $fieldParams) {
                ...
                $columnName = \Finnova\Core\Utils\Util::toUnderScore($fieldName);
