...
<html>
   ...
   <body>
               ...
               <div class="">
                                       ...
                                       <div class="btn-group pull-right mt10" role="group">
                                          <?php
                                             if($userName!="admin"){
                                              ...
                                              $res= mysqli_query($conn, "SELECT * FROM folder_master_3 WHERE id='".$folderId."'");
                                              ...
                                              for($i=0; $i<count($assignUserArr); $i++){
                                                ...
                                                if($singleUser==$userName AND ($singleDefineAccess=="Both" OR $singleDefineAccess=="Upload" )){
                                                  ?>
                                          <button type="button" class="btn btn-danger"><a class="bt" href="uploadFile.php?id=<?php echo $folderId; ?>" style="color:#337AB7;text-decoration: none;"><i class="material-icons-outlined" style="position:relative;top:3px;">cloud_upload</i> Upload File</a></button>
                                          ...
                                          <?php
                                             ...
                                             ?>
                                          <button type="button" class="btn btn-danger bt"><a class="bt" href="createSubFolder.php?id=<?php echo $folderId; ?>"style="color:#337AB7;text-decoration: none;"><i class="material-icons-outlined" style="position:relative;top:3px;">create_new_folder</i> Create Sub Folder</a></button>
                                          <!-- <button type="button" class="btn btn-danger bt" onclick="deletedMultipleSelectedFiles()"> <a class="bt" href="#" style="color:#fff;text-decoration: none;"><i class="fas fa-trash-alt"></i> Delete</a></button> -->
                                          <?php
                                             }
                                          ...
                                          <div class="dropdown" id="action">
                                             ...
                                             <div class="dropdown-menu actionViewDrop">
                                   ...
                                   $.ajax({
                                     ...
                                     success:function(checkValues)
                                     {
                                      ...
                                      div.innerHTML+=checkValues;
                                        ...
                                        $("#ShareViewFolderFilesModal").modal() ;
                                     }
                                   });
                                 },
                                 Cancel: function () {
                        ...
                        <?php
                           ...
                           $output = '';
                            ...
                            $query = "SELECT * FROM document_master_3 WHERE folder_id=$folderID";
                           
                           $result = mysqli_query($connect, $query);
                           
                           
                            $query2 = "SELECT * FROM sub_folder_master_3 WHERE folder_master_id=$folderID";
                                ...
                                <tr>
                                  ...
                                  <td style="overflow:inherit"><div class="dropdown">
                                          ...
                                          <div class="dropdown-menu">
                                            ...
                                            <a href="#" class="dropdown-item btndeletesubfolder btnUpdate" data-deletesubfolder-id="'.$idForcheckBox.'">Delete</a>
                                          </div>
                                        </div>
                                    </td>
                                  ...
                                  <td style="overflow:inherit"><div class="dropdown">
                                          ...
                                          <div class="dropdown-menu">
                                           <a class="dropdown-item" href="downloadFile.php?id='.$row['id'].'">Download</a>
                                            <a  class="dropdown-item btnRename" data-rename-id="'.$idForcheckBox.'" href="#">Rename</a>
                                            <a  class="dropdown-item btnShareSingle" data-sharesingle-id="'.$idForcheckBox.'"  href="#">Share</a>
                                            <a href="#" class="dropdown-item btndeletesubfolderfile btndocumentUpdate" data-deletesubfolderfile-id="'.$idForcheckBox.'">Delete</a>
                                          </div>
                                        </div>
                                    </td>
                                </tr>
      ...
      <div class="modal" id="ShareViewFolderFilesModal">
         <div class="modal-dialog">
            <div class="modal-content">
               <!-- Modal Header -->
               <div class="modal-header">
      ...
      <script>
         /* $(document).ready(function(){
           ...
           function load_data(query)
           {
            ...
            var total_records_per_page_data = '<?php echo $total_records_per_page; ?>';
          
             $.ajax({
               url:"fetchForFolderFiles.php",
               method:"post",
               data:{query:query,offset_data:offset_data,total_records_per_page_data:total_records_per_page_data},
               success:function(data)
               {
                 $('#result').html(data);
               }
