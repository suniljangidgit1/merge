...
class PhoneNumber extends \Finnova\Core\ORM\Repositories\RDB
{
        ...
        if (!empty($phoneNumberValue)) {
            if ($phoneNumberValue !== $entity->getFetched('phoneNumber')) {
                ...
                if (!$phoneNumberNew) {
                    ...
                    $defaultType = $this->getEntityManager()->getFinnovaMetadata()->get('entityDefs.' .  $entity->getEntityType() . '.fields.phoneNumber.defaultType');
