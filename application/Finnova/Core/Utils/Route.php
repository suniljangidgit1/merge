...
class Route
{
    ...
    protected $paths = array(
        'corePath' => 'application/Finnova/Resources/routes.json',
        'modulePath' => 'application/Finnova/Modules/{*}/Resources/routes.json',
        'customPath' => 'custom/Finnova/Custom/{*}/Resources/routes.json',
    );
	...
	$customDataPath = str_replace('{*}', $cacheDataPath, $this->cacheFile);
        ...
        if (file_exists($customDataPath) && $this->getConfig()->get('useCache')) {
            ...
            if ($this->getConfig()->get('useCache')) {
                ...
                if ($result == false) {
                    throw new \Finnova\Core\Exceptions\Error('Route - Cannot save unified routes');
                }
            }
        }
    }
	...
	$customPath = str_replace('{*}', $db, $this->paths['customPath']);
        ...
        $data = $this->getAddData([], $customPath);
