...
<html>
  ...
  <body>
    <!-- Side Navbar -->
    <nav class="side-navbar web-view">
						 ...
						 ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                              <button class="btn btn-primary form-control" id="extraassigniser" type="submit" value="Edit Folder" name="editfolder" style="color:#fff;">Save Changes</button>
                            </div>
