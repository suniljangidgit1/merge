...
class EntityManager
{
    ...
    public function __construct($params)
    {
        ...
        $entityFactoryClassName = '\\Finnova\\ORM\\EntityFactory';
        ...
        $repositoryFactoryClassName = '\\Finnova\\ORM\\RepositoryFactory';
    ...
    public function getQuery()
    {
        if (empty($this->query)) {
            ...
            $className = '\\Finnova\\ORM\\DB\\Query\\' . ucfirst($platform);
    ...
    protected function getMapperClassName($name)
    {
        ...
        switch ($name) {
            case 'RDB':
                $platform = $this->params['platform'];
                $className = '\\Finnova\\ORM\\DB\\' . ucfirst($platform) . 'Mapper';
                break;
        }
