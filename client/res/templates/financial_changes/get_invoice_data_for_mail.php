...
$email_subject = "Invoice - ".$date_year."/".$row5['invoiceno']." from ".$row5['billfromname']."";

echo json_encode(array("invoice_id" => $id, "email_id" => $to_email, "from_email" => $from_email, "mail_subject" => $email_subject));
?>