<div class="page-header labelmanager_header"><h3><a href="#Admin">{{translate 'Administration'}}</a> &raquo {{translate 'System Requirements' scope='Admin'}}</h3></div>
...
<div class="row">
    <div class="col-md-12">
        <div class="pull-right">
            <a target="_blank" href="https://www.fincrm.net/documentation/administration/server-configuration/" style="font-weight:600;">Configuration Instructions</a>
        </div>
    </div>
</div>
