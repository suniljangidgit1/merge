...
namespace Finnova\Core\Mail\Parsers;
...
class ZendMail
{
    ...
    public function fetchContentParts(\Finnova\Entities\Email $email, $message, &$inlineAttachmentList = [])
    {
        $zendMessage = $message->getZendMessage();
    ...
    protected function importPartDataToEmail(\Finnova\Entities\Email $email, $part, &$inlineIds = array(), $defaultContentType = null, &$inlineAttachmentList = [])
    {
        try {
            $type = null;
