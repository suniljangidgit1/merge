...
Finnova.define('views/user/fields/avatar', 'views/fields/image', function (Dep) {
    ...
    return Dep.extend({
        ...
        getValueForDisplay: function () {
            if (this.mode == 'detail' || this.mode == 'list') {
                ...
                if (this.mode == 'detail') {
                    imgHtml = '<img class="img-responsive"  width="40" height="50" src="'+this.getBasePath()+'?entryPoint=avatar&size=' + this.previewSize + '&id=' + userId + '&t=' + t + '&attachmentId=' + ( id || 'false') + '">';
                } else {
