...
class Email extends Record
{
    ...
    public function validateEmailAddresses(\Finnova\Entities\Email $entity)
    {
    ...
    protected function beforeCreateEntity(Entity $entity, $data)
    {
        if ($entity->get('status') == 'Sending') {
            $messageId = \Finnova\Core\Mail\Sender::generateMessageId($entity);
