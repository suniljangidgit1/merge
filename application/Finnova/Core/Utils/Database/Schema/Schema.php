...
class Schema
{
    ...
    protected $fieldTypePaths = array(
        'application/Finnova/Core/Utils/Database/DBAL/FieldTypes',
        'custom/Finnova/Custom/{*}/Core/Utils/Database/DBAL/FieldTypes',
    );
    ...
    protected $rebuildActionsPath = array(
        'corePath' => 'application/Finnova/Core/Utils/Database/Schema/rebuildActions',
        'customPath' => 'custom/Finnova/Custom/{*}/Core/Utils/Database/Schema/rebuildActions',
    );
    ...
    public function __construct(\Finnova\Core\Utils\Config $config, \Finnova\Core\Utils\Metadata $metadata, \Finnova\Core\Utils\File\Manager $fileManager, \Finnova\Core\ORM\EntityManager $entityManager, \Finnova\Core\Utils\File\ClassParser $classParser, \Finnova\Core\Utils\Metadata\OrmMetadata $ormMetadata)
    {
        $this->config = $config;
        ...
        $this->comparator = new \Finnova\Core\Utils\Database\DBAL\Schema\Comparator();
        $this->initFieldTypes();
