...
Finnova.define('crm:views/campaign/record/panels/campaign-log-records', 'views/record/panels/relationship', function (Dep) {
    ...
    return Dep.extend({
    	...
    	setup: function () {
            ...
            this.filterList = Finnova.Utils.clone(this.filterList);
        ...
        actionCreateTargetList: function () {
            ...
            if (!this.collection.data.primaryFilter) {
                ...
                var status = Finnova.Utils.upperCaseFirst(this.collection.data.primaryFilter).replace(/([A-Z])/g, ' $1');
