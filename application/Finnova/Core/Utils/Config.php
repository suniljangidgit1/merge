...
class Config
{
    private $defaultConfigPath = 'application/Finnova/Core/defaults/config.php';

    private $systemConfigPath = 'application/Finnova/Core/defaults/systemConfig.php';
    ...
    public function __construct(\Finnova\Core\Utils\File\Manager $fileManager)
    {
        $this->fileManager = $fileManager;
	include('application/Finnova/Core/Utils/myconfig.php');
	$this->configPath = $testconfigfile;
    }
