...
(function() {
    ...
    function hb(k) {
        if (!ib) {
            ...
            if (k.creditHref && k.creditText) {
                k._creditLink ||
                    (k._creditLink = document.createElement("a"), k._creditLink.setAttribute("class", ""), k._creditLink.setAttribute("title", ""), k._creditLink.setAttribute("style", "display:none;outline:none;margin:0px;position:absolute;right:2px;top:" + (k.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"), k._creditLink.setAttribute("tabIndex", -1), k._creditLink.setAttribute("target", "_blank"));
                if (0 === k.renderCount ||
    ...
    var Ja = !1,
        ...
        Ba = {
            colorSet1: "#23BFAA #23BFAA #23BFAA #23BFAA #23BFAA #23BFAA #23BFAA #23BFAA #23BFAA #23BFAA #23BFAA".split(" "),
