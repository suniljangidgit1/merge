    ...
    _.extend(Controller.prototype, {
        ...
        handleAccessGlobal: function () {
            if (!this.checkAccessGlobal()) {
                throw new Finnova.Exceptions.AccessDenied("Denied access to '" + this.name + "'");
            }
        },
        ...
        handleCheckAccess: function (action) {
            if (!this.checkAccess(action)) {
                ...
                throw new Finnova.Exceptions.AccessDenied(msg);
            }
        },
        ...
        doAction: function (action, options) {
            ...
            if (!(method in this)) {
                throw new Finnova.Exceptions.NotFound("Action '" + this.name + "#" + action + "' is not found");
            }

            var preMethod = 'before' + Finnova.Utils.upperCaseFirst(action);
            var postMethod = 'after' + Finnova.Utils.upperCaseFirst(action);
