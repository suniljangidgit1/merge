...
class EmailAccount extends Record
{
    ...
    public function findAccountForUser(\Finnova\Entities\User $user, $address)
    {
    ...
    public function getSmtpParamsFromAccount(\Finnova\Entities\EmailAccount $emailAccount)
    {
        $smtpParams = [];
