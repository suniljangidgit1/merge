...
var Finnova = Finnova || {classMap:{}};

(function (Finnova, _, $) {

    var root = this;

    Finnova.Loader = function (cache, cacheTimestamp) {
    ...
    _.extend(Finnova.Loader.prototype, {
    ...
    Finnova.loader = new Finnova.Loader();

    root.require = Finnova.require = function (subject, callback, context, errorCallback) {
        if (context) {
            callback = callback.bind(context);
        }
        Finnova.loader.require(subject, callback, errorCallback);
    }

    root.define = Finnova.define = function (arg1, arg2, arg3) {
        var subject = null;
        var dependency = null;
        var callback = null;
        ...
        Finnova.loader.define(subject, dependency, callback);
    }

    Finnova.loadLib = function (url, callback) {
        Finnova.loader.loadLib(url, callback);
    }
