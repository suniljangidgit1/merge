...
$pdf->Cell($width_cell4[1],5,$row1['invoiceno'],'LBR',0,'L',false); // Second header column
$pdf->Cell($width_cell4[2],5,date("d-M-Y",strtotime($row1['invoicedate'])),'LBR',0,'L',false); // Third header column 
...
$pdf->Cell($width_cell4[1],5,$row1['placeofsupply'],'LBR',0,'L',false); // Second header column
$pdf->Cell($width_cell4[2],5,date("d-M-Y",strtotime($row1['duedate'])),'LBR',0,'L',false); // Third header column 
...
$pdf->Cell($width_cell4[1],5,$row1['buyerorderno'],'LR',0,'L',false); // Second header column
$pdf->Cell($width_cell4[2],5,date("d-M-Y",strtotime($row1['orderdate'])),'LR',0,'L',false); // Third header column 

$pdf->Ln();

$pdf->SetFont('Times','',10);
$pdf->Cell($width_cell4[0],5,'PAN : '.strtoupper($pan),'LR',0,'L',false); // First header column
$pdf->Cell($width_cell4[1],5,'','LR',0,'L',false); // Second header column
$pdf->Cell($width_cell4[2],5,'','LR',0,'L',false); // Third header column 

$pdf->Ln();

$pdf->SetFont('Times','',10);
$pdf->Cell($width_cell4[0],2,'','L',0,'L',false); // First header column
$pdf->Cell($width_cell4[1],2,'','LR',0,'L',false); // Second header column
...
$sql3="select * from invoice_items where invoice_id='$invoice_id'";
...
while($row3=mysqli_fetch_assoc($result3))
{
    ...
    $amount=$row3['quantity'] * $row3['rate'];
...
$pdf->Cell($width_cellT[1],5,'Beneficiary: '.$row1['beneficiary'],'LR',0,'L',false); // Second header column

$pdf->Ln();

$pdf->SetFont('Times','',10);
$pdf->Cell($width_cellT[0],5,'','LR',0,'L',false); // First header column 
$pdf->Cell($width_cellT[1],5,'Bank: '.$row1['bankname'],'LR',0,'L',false); // Second header column

$pdf->Ln();

$pdf->SetFont('Times','',10);
$pdf->Cell($width_cellT[0],5,'','LR',0,'L',false); // First header column 
$pdf->Cell($width_cellT[1],5,'Branch: '.$row1['branch'],'LR',0,'L',false); // Second header column

$pdf->Ln();

$pdf->SetFont('Times','',10);
$pdf->Cell($width_cellT[0],5,'','LR',0,'L',false); // First header column 
$pdf->Cell($width_cellT[1],5,'Account No.: '.$row1['accountno'],'LR',0,'L',false); // Second header column

$pdf->Ln();

$pdf->SetFont('Times','',10);
$pdf->Cell($width_cellT[0],5,'','LRB',0,'L',false); // First header column 
$pdf->Cell($width_cellT[1],5,'IFSC Code: '.$row1['ifsc'],'LRB',0,'L',false); // Second header column
