...
#edit_estimate_main_details .estimateDiffGSTNum,
#edit_estimate_main_details .estimateDiffcustomer,
#edit_estimate_main_details .estimateDiffcustomergst{
    color: #337AB7;
    cursor: pointer;
    font-size: 14px;
}
                  ...
                  $output .= '<div id="BillingToAddress_edit" class="BillingToAddress" style="display: none;">
                           ...
                           $output .= '<tr>
                                    ...
                                    <td class="width_15 discount_section">
                                      <select name="edit_item_discount_type[]" id="edit_item_discount_type'.$count.'" class="Estimate_Percentage form-control ">
                                        <option value="Select Type" '.$disc_type_selected2.'>Select Type</option>
                              ...
                              $output .= '<td class="width_10"><span class="material-icons-outlined estimate_remove_adddiscount"'.$display1.'>delete_outline</span>
                                  ...
                                  <tr id="edit_SGST_Discount" class="SGST_Discount"'.$display2.'>
                                    ...
                                    <td class="width_10"><span class="material-icons-outlined estimate_remove_adddiscount"'.$display2.'>delete_outline</span>
                                    </td>
                                  </tr>';
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <center>
                          <div class="edit_Estimate_add"><span class="material-icons-outlined" style="top:4px;">add_circle_outline</span> Add on item</div>
                        </center>
          ...
          <div class="col-md-12">
            <div class="panel panel-default" id="edit_estimate_calculation">
              <div class="panel-heading" '.$hide_color_apply_css.'>
                <div class="table-responsive">
                  ...
                  $output .= '<input type="hidden" id="hidden_estimate_discount_type" value="'.$row1['discounttype'].'" />
                    ...
                    <tr class="edit_estimate_effect CGST_TR_section" '.$est_gst_display.'>
                      <td></td>
                      <td></td>
                      <td></td>
              ...
              $output .= '<td class="width_15 GST_section">
                      ...
                      <td class="width_10"><span class="material-icons-outlined estimate_remove_adddiscount"'.$disp_style.'>delete_outline</span>
                      </td>
                    </tr>
