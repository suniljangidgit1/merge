...
Company - has Email, Phone, Billing Address, Shipping Address fields; Activities, History, Tasks panels.',
  ...
  array (
    ...
    array (
      ...
      'SenderID' => 'Sender ID',
      'TestDemo' => 'Test Demo',
      'MonsterData45To6' => 'Monster Data (4.5 to 6)',
      'HRCompanies' => 'HR Companies',
    ...
    array (
      ...
      'SenderID' => 'Sender IDs',
      'TestDemo' => 'Test Demos',
      'MonsterData45To6' => 'Monster Data (4.5 to 6)s',
      'HRCompanies' => 'HR Companieses',
...
- \'Principal\' - the form \'tester@company.com\'.',
      ...
      'ldapBaseDn' => 'The default base DN used for searching users. E.g. "OU=users,OU=finnovacrm,DC=test, DC=lan".',
      ...
      'ldapCreateFinnovaUser' => 'This option allows FinnovaCRM to create a user from the LDAP.',
...
Disabled: Access to scopes will be allowed if it\'s not specified in roles.',
  ...
  array (
    ...
    array (
      ...
      'billAmountCurrency' => 'Bill Amount (Currency)',
      'billAmountConverted' => 'Bill Amount (Converted)',
      'billDate' => 'Bill Date',
      'bill' => 'Bill Copy',
    ...
    'labels' => 
    array (
      'Create CACertificate' => 'Create CA Certificate',
    ),
    'options' => 
    array (
      'billable' => 
  ...
  array (
    ...
    array (
      ...
      'shippingAddress' => 'Shipping Address',
      'website' => 'Website',
      'amountRsInCrore' => 'Amount (Rs in Crore)',
      'amountRsInCroreCurrency' => 'Amount (Rs in Crore) (Currency)',
      'amountRsInCroreConverted' => 'Amount (Rs in Crore) (Converted)',
      'concernedPerson' => 'Concerned Person',
      'designation' => 'Designation',
      'documents' => 'Documents',
      'latestRatingDate' => 'Latest Rating Date',
      'leadType' => 'Lead Type',
      'presentBanker' => 'Present Banker',
      'rating' => 'Rating',
    ...
    'labels' => 
    array (
      'Create ClientUnderDiscussion' => 'Create Client Under Discussion',
    ),
    'options' => 
    array (
      'leadType' => 
      ...
      array (
        'Live' => 'Live',
        'Suspended' => 'Suspended',
        'Non Cooperating' => 'Non Cooperating',
  ...
  array (
    ...
    array (
      ...
      'bankers' => 'Bankers',
      'cINNo' => 'CIN No',
      'chargesRsInCrore' => 'Charges (Rs in Crore)',
      'concernedPerson' => 'Concerned Person',
      ...
      'reference' => 'Reference',
      'stream' => 'Stream',
      'paidUpCapitalRsInCrore' => 'Paid up Capital (Rs in Crore)',
    ),
    'links' => 
    array (
      'meetings' => 'Meetings',
    ...
    'labels' => 
    array (
      'Create CorporateDataBase' => 'Create Corporate Data Base',
    ),
    'options' => 
    array (
      'constitution' => 
      array (
        ...
        'Company - Public Limited' => 'Company - Public Limited',
      ),
    ),
  ),
  'DUMMMMYYYY' => 
  array (
    ...
    'labels' => 
    array (
      'Create DUMMMMYYYY' => 'Create DUMMMMYYYY',
    ),
  ),
  'Designation' => 
  array (
  ...
  array (
    ...
    'labels' => 
    array (
      'Create HRCompanies' => 'Create HR Companies',
    ),
  ),
  'MonsterData45To6' => 
  array (
    ...
    'labels' => 
    array (
      'Create MonsterData45To6' => 'Create Monster Data (4.5 to 6)',
    ),
  ),
  'Properties' => 
  array (
  ...
  array (
    ...
    array (
      'address' => 'Address',
      'realEstateLeadss' => 'Real Estate Leadss',
    ),
    'links' => 
    array (
      'meetings' => 'Meetings',
    ...
    'labels' => 
    array (
      'Create RealEstateFLats' => 'Create RealEstate FLats',
    ),
  ),
  'RealEstateLeads' => 
  array (
    ...
    array (
      ...
      'shippingAddress' => 'Shipping Address',
      'website' => 'Website',
      'realEstateFLatss' => 'Real Estate FLatss',
    ),
    'links' => 
    array (
      'meetings' => 'Meetings',
    ...
    'labels' => 
    array (
      'Create RealEstateLeads' => 'Create Real Estate Leads',
    ),
  ),
  'TESTDATAA' => 
  array (
    ...
    'labels' => 
    array (
      'Create TESTDATAA' => 'Create TEST DATAA',
    ),
  ),
  'Test071120' => 
  array (
    ...
    'labels' => 
    array (
      'Create Test071120' => 'Create Test071120',
    ),
  ),
);
?>