...
Finnova.define('views/dashlets/fields/records/expanded-layout', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        afterRender: function () {
            ...
            rowList = Finnova.Utils.cloneDeep(rowList);
