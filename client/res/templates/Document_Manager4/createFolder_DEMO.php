...
<body>
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="#"><em class="fa fa-bar-chart">&nbsp;</em> Create Folder</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 main" style="width:100%;">
		...
		<label>Folder Name:</label>
			...
			<select name="user">
						...
						<input type="button" class="btn btn-primary" id="btRemoveAll" value="Remove All" class="bt" />
						</div>
			<br>
	...
	<script>
					$(document).ready(function() {
						...
						var container = $(document.createElement('div')).css({
							position: 'relative', left: '50px', top:'50px', padding: '5px', margin: '20px', width: '170px',
