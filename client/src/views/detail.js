...
define('views/detail', 'views/main', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionFollow: function () {
            ...
            Finnova.Ajax.putRequest(this.model.name + '/' + this.model.id + '/subscription')
                .then(function () {
                    this.removeMenuItem('follow', true);
        ...
        actionUnfollow: function () {
            ...
            Finnova.Ajax.deleteRequest(this.model.name + '/' + this.model.id + '/subscription')
                .then(function () {
                    this.removeMenuItem('unfollow', true);
        ...
        actionSelectRelated: function (data) {
            ...
            var filters = Finnova.Utils.cloneDeep(this.selectRelatedFilters[link]) || {};
            ...
            var boolFilterList = dataBoolFilterList || Finnova.Utils.cloneDeep(this.selectBoolFilterLists[link] || []);
