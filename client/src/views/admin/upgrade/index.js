    ...
    return Dep.extend({
        ...
        data: function () {
            return {
                ...
                infoMsg: this.translate('upgradeInfo', 'messages', 'Admin').replace('{url}', 'https://www.fincrm.net/documentation/administration/upgrading/'),
                ...
                downloadMsg: this.translate('downloadUpgradePackage', 'messages', 'Admin').replace('{url}', 'https://www.fincrm.net/download/upgrades')
            };
        },
