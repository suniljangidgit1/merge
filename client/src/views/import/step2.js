...
Finnova.define('views/import/step2', 'view', function (Dep) {
    ...
    return Dep.extend({
            ...
            for (var field in fields) {
                ...
                if (d.type == 'phone') {
                    ...
                    (this.getMetadata().get('entityDefs.' + this.scope + '.fields.' + field + '.typeList') || []).map(function (item) {
                        ...
                        attributeList.push(field + Finnova.Utils.upperCaseFirst(item));
                    }, this);
                    continue;
                }
        ...
        addField: function (name) {
            ...
            var type = Finnova.Utils.upperCaseFirst(this.model.getFieldParam(name, 'type'));
