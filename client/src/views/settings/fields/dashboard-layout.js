...
Finnova.define('views/settings/fields/dashboard-layout', ['views/fields/base', 'lib!gridstack'], function (Dep, Gridstack) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            this.dashboardLayout = Finnova.Utils.cloneDeep(this.model.get(this.name) || []);
            this.dashletsOptions = Finnova.Utils.cloneDeep(this.model.get('dashletsOptions') || {});
        ...
        editDashlet: function (id, name) {
            ...
            options = Finnova.Utils.cloneDeep(options);
            ...
            Object.keys(defaultOptions).forEach(function (item) {
                ...
                options[item] = Finnova.Utils.cloneDeep(defaultOptions[item]);
            }, this);
        ...
        fetch: function () {
            ...
            if (!this.dashboardLayout || !this.dashboardLayout.length) {
                ...
                data[this.name] = Finnova.Utils.cloneDeep(this.dashboardLayout);
            }

            data['dashletsOptions'] = Finnova.Utils.cloneDeep(this.dashletsOptions);
