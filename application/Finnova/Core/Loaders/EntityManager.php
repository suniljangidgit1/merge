...
namespace Finnova\Core\Loaders;
...
class EntityManager extends Base
{
    public function load()
    {
        ...
        $params = array(
            ...
            'repositoryFactoryClassName' => '\\Finnova\\Core\\ORM\\RepositoryFactory',
        ...
        $entityManager = new \Finnova\Core\ORM\EntityManager($params);
        $entityManager->setFinnovaMetadata($this->getContainer()->get('metadata'));
