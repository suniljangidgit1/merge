    ...
    return Dep.extend({
        ...
        events: {
            ...
            'click .actions-menu a.mass-action': function (e) {
                ...
                var method = 'massAction' + Finnova.Utils.upperCaseFirst(action);
                if (method in this) {
                    this[method]();
                } else {
        ...
        data: function () {
            ...
            var topBar =
                ...
                //hide merge & massUpdate on action list
                if(current_url == "#ContactList" || current_url == "#MyCampaigns" || current_url == "#SentMessages" || current_url == "#ImportResult" || current_url == "#ContentTemplate" || current_url == "#SMSReminder" || current_url == "#SendSMSData" || current_url == "#EmailReminder" || current_url == "#SentEmailReminder" || current_url == "#BillingEntity" || current_url == "#Estimate" || current_url == "#Invoice" || current_url == "#Payments"){
        ...
        init: function () {
            ...
            this.dropdownItemList = Finnova.Utils.cloneDeep(this.options.dropdownItemList || this.dropdownItemList);
        ...
        export: function (data, url, fieldList) {
            ...
            //         Finnova.Ajax.postRequest(url, data, {timeout: 0}).then(function (data) {
        ...
        massAction: function (name) {
            ...
            var proceed = function () {
                ...
                Finnova.Ui.notify(this.translate(waitMessage, 'messages', this.scope));
        ...
        massActionRecalculateFormula: function () {
            this.confirm({
                ...
                Finnova.Ajax.postRequest(this.entityType + '/action/massRecalculateFormula', data).then(function (result) {
                    result = result || {};
                    this.collection.fetch().then(function () {
        ...
        massActionRemove: function () {
            ...
            this.confirm({
                ...
                Finnova.Ajax.postRequest(this.entityType + '/action/massDelete', data).then(function (result) {
                    result = result || {};
                    ...
                    if (this.allResultIsChecked) {
                        if (count) {
                            ...
                            this.listenToOnce(this.collection, 'sync', function () {
                                ...
                                Finnova.Ui.success(this.translate(msg, 'messages').replace('{count}', count));
                            }, this);
                            this.collection.fetch();
                            Finnova.Ui.notify(false);
                        } else {
                            Finnova.Ui.warning(this.translate('noRecordsRemoved', 'messages'));
                        }
                    } else {
                        var idsRemoved = result.ids || [];
                                ...
                                $.ajax({
                                    type: "GET",
                                    url: "../../client/res/templates/financial_changes/remove_MultipleFiles.php",
                                    data: {idsRemoved:idsRemoved,entity:entity},
            ...
            this.confirm({
                ...
                this.ajaxPostRequest(this.entityType + '/action/massFollow', {
                    ...
                    if (resultCount) {
                        ...
                        Finnova.Ui.success(this.translate(msg, 'messages').replace('{count}', resultCount));
                    } else {
                        Finnova.Ui.warning(this.translate('massFollowZeroResult', 'messages'));
                    }
                }.bind(this));
            }, this);
        },
            ...
            this.confirm({
                ...
                this.ajaxPostRequest(this.entityType + '/action/massUnfollow', {
                    ...
                    if (resultCount) {
                        ...
                        Finnova.Ui.warning(this.translate('massUnfollowZeroResult', 'messages'));
                    }
                }.bind(this));
            }, this);
        },
                ...
                view.once('after:update', function (count) {
                    ...
                    this.listenToOnce(this.collection, 'sync', function () {
                        if (count) {
                            ...
                            Finnova.Ui.warning(this.translate('noRecordsUpdated', 'messages'));
                        }
                        if (allResultIsChecked) {
                            this.selectAllResult();
                        } else {
        ...
        massActionUnlink: function () {
            this.confirm({
                ...
                Finnova.Ajax.deleteRequest(this.collection.url, {
                    ids: this.checkedList
                }).then(function () {
        ...
        setup: function () {
            ...
            this.events = Finnova.Utils.clone(this.events);
            this.massActionList = Finnova.Utils.clone(this.massActionList);
            this.buttonList = Finnova.Utils.clone(this.buttonList);
            ...
            (this.getMetadata().get(['clientDefs', this.scope, 'massActionList']) || []).forEach(function (item) {
                ...
                if (!Finnova.Utils.checkActionAvailability(this.getHelper(), defs)) return;
                if (!Finnova.Utils.checkActionAccess(this.getAcl(), null, defs)) return;
            ...
            if (this.collection.url !== this.entityType) {
                Finnova.Utils.clone(this.checkAllResultMassActionList).forEach(function (item) {
            ...
            Finnova.Utils.clone(this.massActionList).forEach(function (item) {
                var propName = 'massAction' + Finnova.Utils.upperCaseFirst(item) + 'Disabled';
        ...
        filterListLayout: function (listLayout) {
            ...
            filteredListLayout = Finnova.Utils.clone(listLayout);
        ...
        buildRow: function (i, model, callback) {
            ...
            this.getInternalLayout(function (internalLayout) {
                internalLayout = Finnova.Utils.cloneDeep(internalLayout);
        ...
        actionQuickRemove: function (data) {
            ...
            $.ajax({
                    type: "GET",
                    url: "../../client/res/templates/financial_changes/remove_SingleRecord.php",
                    data: {id:id},
                    success: function (data){
