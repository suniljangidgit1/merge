...
define('views/email/record/detail', 'views/record/detail', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionMarkAsImportant: function () {
            Finnova.Ajax.postRequest('Email/action/markAsImportant', {
                id: this.model.id
            });
        ...
        actionMarkAsNotImportant: function () {
            Finnova.Ajax.postRequest('Email/action/markAsNotImportant', {
                id: this.model.id
            });
        ...
        actionMoveToTrash: function () {
            Finnova.Ajax.postRequest('Email/action/moveToTrash', {
                id: this.model.id
            }).then(function () {
                Finnova.Ui.warning(this.translate('Moved to Trash', 'labels', 'Email'));
            }.bind(this));
        ...
        actionRetrieveFromTrash: function () {
            Finnova.Ajax.postRequest('Email/action/retrieveFromTrash', {
                id: this.model.id
            }).then(function () {
                Finnova.Ui.warning(this.translate('Retrieved from Trash', 'labels', 'Email'));
            }.bind(this));
        ...
        send: function () {
            ...
            var afterSend = function () {
                Finnova.Ui.success(this.translate('emailSent', 'messages', 'Email'));
            ...
            this.once('before:save', function () {
                Finnova.Ui.notify(this.translate('Sending...', 'labels', 'Email'));
            }, this);
