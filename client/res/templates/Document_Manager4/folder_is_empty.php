      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
             <li><a href="index.php"> <i class="far fa-folder"></i>Files/Folders                             </a></li>
            ...
            <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Media Files </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
               <li><a href="viewPictures.php"><i class="fas fa-images"></i>Pictures</a></li>
                <li><a href="viewAudio.php"><i class="fas fa-music"></i>Audio</a></li>
                <li><a href="viewVideo.php"><i class="fas fa-video"></i>Video</a></li>
              </ul>
            </li>
        ...
        <div class="container-fluid">
          <div class="row d-flex align-items-md-stretch">
          	<div class="col-md-6 offset-md-3">
				<center><h4>Sorry, This folder is empty you could not be downloaded!!</h4></center>
			</div>
          </div>
        </div>
      </section>
