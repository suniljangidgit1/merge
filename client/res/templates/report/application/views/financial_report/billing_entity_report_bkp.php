               ...
               <div class="table-responsive">
               		...
               		<tbody><?php
               			if(!empty($billEntityArr)){
               				// echo "<pre>";print_r($billEntityArr);die;
               				foreach($billEntityArr as $billEntArr){ ?>
               					<tr class="list-row">
               						<td class="cell">
               							<a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/#BillingEntity/view/<?php echo $billEntArr['id'];?>"><?php echo $billEntArr['name'];?></a>
               						</td>
               						<?php $p = getbillingentitiesinvoices($billEntArr['id'], $filterData);
               						if($p["amt_receivable"] !=0){ ?>
			               				...
			               				<td>
			               					<a href="" class="view_details" data-id="<?php echo $billEntArr['id'];?>" data-startDate="<?php echo $filterData['invoice_start_date'];?>" data-endDate="<?php echo $filterData['invoice_end_date'];?>">View</a>
			               				</td><?php
               						}
               						else { ?>
	               						<td class="cell">₹ 0</td>
               				...
               				/*foreach($billEntityArr as $billEntArr){ ?>
               					<tr class="list-row">
               						<td class="cell">
               							<a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/#BillingEntity/view/<?php echo $billEntArr['billing_entity_id'];?>"><?php echo $billEntArr['billing_entity_name'];?></a>
               						</td>
               						<td class="cell"><?php echo ($billEntArr['total']) ? '₹ '.number_format($billEntArr['total'],2) : '₹ 0';?></td>
		               				<td class="cell"></td>
		               				<td class="cell"></td>
		               				<td class="cell"></td>
		               				<td>
		               					<a href="" class="view_details" data-id="<?php echo $billEntArr['billing_entity_id'];?>">View</a>
		               				</td>
               					</tr><?php
               				}*/
               			}
