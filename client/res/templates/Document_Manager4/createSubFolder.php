              ...
              <div class="" style="margin-top: 40px;">
                <div class="row">
                  <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 main">
                    <div class="dm_upload">
                     <h2 class="text-center mb-4" style="margin-right: 40px;">Create Sub Folder</h2>
                   <?php
                        ...
                        <input type="hidden" name="usercount" id="inputcountusers">
                          <div class="form-group row">
                            ...
                            <div class="col-11 col-xs-11 col-sm-11 col-md-11 col-lg-11">
                              <input class="form-control" type="text" name="subFolderName" placeholder="Enter folder name" required/>
                            </div>
                          </div>
                         <div class="form-group row">
                            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                              <select id="idfisrtselectbox" class="classfisrtselectbox form-control" name="assignUser">
              ...
              function GetTextValue() {
                ...
                $('body').append(divValue);
                            ...
                            <div class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-4">
                              <button class="btn btn-primary form-control" id="extraassigniser" type="submit" name="createsubfolder" value="Create Sub Folder" style="color:#fff;width:104%;">Create Sub Folder</button>
                            </div>
...
{ 
  ...
  if($subFolderNameInDB != $_POST['subFolderName']){
      ...
      $res = mysqli_query($conn, "SELECT * FROM sub_folder_master_3 WHERE id=".$_GET['id'] );
    $row= mysqli_fetch_array($res);
    $folder_path = $row['folder_path'];
  
    if($folder_path == ""){
      $resFM = mysqli_query($conn, "SELECT * FROM folder_master_3 WHERE id=".$folderID);
      $rowFM = mysqli_fetch_array($resFM);

      $folder_path = $rowFM['folder_name']."/".$_POST['subFolderName'].'/';
    }else{
      $folder_path = $folder_path.$_POST['subFolderName'].'/';
    }
    // if(!is_dir("upload/".$_SERVER['SERVER_NAME'].'/'.$folder_path)){
    //    mkdir("upload/".$_SERVER['SERVER_NAME'].'/'.$folder_path);
    //    chmod("upload/".$_SERVER['SERVER_NAME'].'/'.$folder_path, 0777);
    //   }
    ...
    // Create S3 object ....  
        ...
        //  $result = $s3->putObject([
        //     'Bucket' => 'fincrm',
        //     'Key'    => 'Development/'.$_SERVER['SERVER_NAME'].'/document_manager/'.$folder_path,
        //     //'SourceFile' => $temp_file_location         
        // ]);

    $result_orignal_for_folder=mysqli_query($conn , "INSERT INTO sub_folder_master_3(folder_master_id, folder_name, created_user_id, assigned_user_id, defineAccess, folder_path) VALUES('".$folderID."', '".$_POST['subFolderName']."', '".$userName."', '".$datauser."', '".$dataaccess."', '".$folder_path."')");
