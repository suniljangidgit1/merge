...
class UserSecurity extends \Finnova\Core\Services\Base
{
    ...
    protected function verify2FATotp(\Finnova\Entities\UserData $userData, $data) : bool
    {
        $code = $data->code ?? null;
    ...
    protected function generate2FADataTotp(\Finnova\Entities\UserData $userData, $data)
    {
