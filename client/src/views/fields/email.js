...
Finnova.define('views/fields/email', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            if (this.mode == 'edit') {
                emailAddressData = Finnova.Utils.clone(this.model.get(this.dataFieldName));
            ...
            if (emailAddressData) {
                emailAddressData = Finnova.Utils.cloneDeep(emailAddressData);
