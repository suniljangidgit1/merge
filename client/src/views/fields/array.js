    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listenTo(this.model, 'change:' + this.name, function () {
                this.selected = Finnova.Utils.clone(this.model.get(this.name)) || [];
            }, this);
            ...
            if (this.params.isSorted && this.translatedOptions) {
                this.params.options = Finnova.Utils.clone(this.params.options);
        ...
        setOptionList: function (optionList, silent) {
            ...
            this.params.options = Finnova.Utils.clone(optionList);
        ...
        resetOptionList: function () {
            if (this.originalOptionList) {
                this.params.options = Finnova.Utils.clone(this.originalOptionList);
            }
        ...
        fetch: function () {
            var data = {};
            var list = Finnova.Utils.clone(this.selected || []);
