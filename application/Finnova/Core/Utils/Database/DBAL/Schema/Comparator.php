...
namespace Finnova\Core\Utils\Database\DBAL\Schema;
...
class Comparator extends \Doctrine\DBAL\Schema\Comparator
{
    public function diffColumn(Column $column1, Column $column2)
    {
        ...
        if ( $column1->getType() != $column2->getType() ) {
            ...
            //finnova: fix problem with executing query for custom types
        ...
        if ($column1->getType() instanceof \Doctrine\DBAL\Types\StringType) {
            ...
            /** Finnova: column length can be increased only */
            /*if ($length1 != $length2) {
        ...
        /** Finnova: do not change a field length while changing other parameters */
            ...
            foreach ($table1Indexes as $index1Name => $index1Definition) {
                if ($this->diffIndex($index1Definition, $index2Definition) === false) {
                    ...
                    if ($index1Name == $index2Name) {
                        /*finnova*/ if (isset($table2Indexes[$index2Name])) { /*finnova*/
