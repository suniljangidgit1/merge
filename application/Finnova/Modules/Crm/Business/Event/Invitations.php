...
namespace Finnova\Modules\Crm\Business\Event;
...
class Invitations
{
    ...
    public function sendInvitation(Entity $entity, Entity $invitee, $link)
    {
        ...
        $htmlizer = new \Finnova\Core\Htmlizer\Htmlizer($this->fileManager, $dateTime, $this->number, null);
    ...
    protected function getIscContents(Entity $entity)
    {
        ...
        $ics = new Ics('//FinnovaCRM//FinnovaCRM Calendar//EN', [
