...
<?php
	...
	if(isset($_POST["query"]))
	{
		...
		$query1 = "SELECT * FROM document_master WHERE document_name LIKE '%".$search."%' 
	...
	if(isset($_POST["query"]))
	{
		...
		$query2 = " SELECT * FROM sub_folder_master WHERE folder_name LIKE '%".$search."%' AND id= '".$folderID."' LIMIT $offset,$total_records_per_page";
		//echo $query2;
	}
	else
	{
		...
		while($rowForFolder = mysqli_fetch_array($resultForFolder)){
			...
			$output .= '
				<tr>
					...
					<td><a href="newdownloadSubFolder.php?id='.$rowForFolder['id'].'"><i class="fa fa-download fa-1x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="editSubFolder.php?id='.$rowForFolder['id'].'"><i class="fa fa-pencil-square-o fa-1x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a class="btndeletesubfolder" href="#" data-deletesubfolder-id='.$rowForFolder['id'].'><i class="fa fa-trash fa-1x"></i></a></td>
				</tr>
			';
		}					
		...
		//	echo "FILE TYPE = ". $file_type;					
			...
			$output .= '
				<tr>
					...
					<td>'.$row["createdAt"].'</td>
					<td><a href="downloadFile.php?id='.$row['id'].'"><i class="fa fa-download fa-1x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="editFile.php?id='.$row['id'].'"><i class="fa fa-pencil-square-o fa-1x"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="btndocumentUpdate" data-documentupdate-id='.$row['id'].'><i class="fa fa-trash fa-1x"></i></a></td>
				</tr>
			';
