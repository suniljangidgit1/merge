...
namespace Finnova\ORM\Repositories;

use \Finnova\ORM\EntityManager;
use \Finnova\ORM\EntityFactory;
use \Finnova\ORM\EntityCollection;
use \Finnova\ORM\Entity;
use \Finnova\ORM\IEntity;


class RDB extends \Finnova\ORM\Repository
{
    /**
     * @var Object Mapper.
     */
    ...
    public function findByQuery(string $sql, ?string $collectionType = null)
    {
        ...
        } else if ($collectionType === \Finnova\ORM\EntityManager::STH_COLLECTION) {
