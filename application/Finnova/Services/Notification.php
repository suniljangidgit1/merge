...
class Notification extends \Finnova\Services\Record
{
    ...
    public function notifyAboutNote(array $userIdList, \Finnova\Entities\Note $note)
    {
        $data = ['noteId' => $note->id];
        ...
        foreach ($userList as $user) {
            ...
            $id = \Finnova\Core\Utils\Util::generateId();
    ...
    public function checkUserNoteAccess(\Finnova\Entities\User $user, \Finnova\Entities\Note $note)
    {
        if ($user->isPortal()) {
