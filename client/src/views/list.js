...
define('views/list', ['views/main', 'search-manager'], function (Dep, SearchManager) {
    ...
    return Dep.extend({
        ...
        setViewMode: function (mode, toStore) {
            ...
            var methodName = 'setViewMode' + Finnova.Utils.upperCaseFirst(this.viewMode);
            if (this[methodName]) {
                this[methodName]();
                return;
            }
        ...
        getRecordViewName: function () {
            ...
            var propertyName = 'record' + Finnova.Utils.upperCaseFirst(this.viewMode) + 'View';
        ...
        loadList: function () {
            var methodName = 'loadList' + Finnova.Utils.upperCaseFirst(this.viewMode);
            if (this[methodName]) {
                this[methodName]();
                return;
            }
