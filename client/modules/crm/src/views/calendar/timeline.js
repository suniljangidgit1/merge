...
Finnova.define('crm:views/calendar/timeline', ['view', 'lib!vis'], function (Dep, Vis) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.colors = Finnova.Utils.clone(this.getMetadata().get('clientDefs.Calendar.colors') || this.colors || {});
            ...
            this.scopeList = this.getConfig().get('calendarEntityList') || Finnova.Utils.clone(this.scopeList) || [];
            ...
            if (this.header) {
                this.enabledScopeList = this.getStoredEnabledScopeList() || Finnova.Utils.clone(this.scopeList);
            } else {
                this.enabledScopeList = this.options.enabledScopeList || Finnova.Utils.clone(this.scopeList);
            }
        ...
        initUserList: function () {
            if (this.options.userList) {
                this.userList = Finnova.Utils.clone(this.options.userList);
        ...
        storeUserList: function () {
            this.getPreferences().save({
                'sharedCalendarUserList': Finnova.Utils.clone(this.userList)
            }, {patch: true});
        },
        ...
        getSharedCalenderUserList: function () {
            var list = Finnova.Utils.clone(this.getPreferences().get('sharedCalendarUserList'));
