        ...
        createPerson: function (scope, address) {
            ...
            this.createView('create', viewName, {
                ...
                this.listenTo(view, 'after:save', function (model) {
                    var nameHash = Finnova.Utils.clone(this.model.get('nameHash') || {});
                    var typeHash = Finnova.Utils.clone(this.model.get('typeHash') || {});
                    var idHash = Finnova.Utils.clone(this.model.get('idHash') || {});
