...
Finnova.define('views/admin/layouts/detail', 'views/admin/layouts/grid', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.panelDataAttributesDefs = Finnova.Utils.cloneDeep(this.panelDataAttributesDefs);
        ...
        loadLayout: function (callback) {
            ...
            if (~['detail', 'detailSmall'].indexOf(this.type)) {
                promiseList.push(
                    new Promise(function (resolve) {
                        this.getHelper().layoutManager.get(this.scope, 'sidePanels' + Finnova.Utils.upperCaseFirst(this.type), function (layoutLoaded) {
                ...
                new Promise(
                    function (resolve) {
                        ...
                        this.getHelper().layoutManager.get(this.scope, 'defaultSidePanel', function (layoutLoaded) {
                            ...
                            this.defaultPanelFieldList = Finnova.Utils.clone(this.defaultPanelFieldList);
