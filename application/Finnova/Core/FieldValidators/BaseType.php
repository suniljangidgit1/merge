...
class BaseType
{
    ...
    public function __construct(\Finnova\Core\Utils\Metadata $metadata, \Finnova\Core\Utils\FieldManagerUtil $fieldManagerUtil)
    {
    ...
    protected function getMetadata() : \Finnova\Core\Utils\Metadata
    {
        return $this->metadata;
    }

    protected function getFieldManagerUtil() : \Finnova\Core\Utils\FieldManagerUtil
    {
