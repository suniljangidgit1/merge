...
Finnova.define('views/dashlets/options/base', ['views/modal', 'views/record/detail', 'model', 'view-record-helper'], function (Dep, Detail, Model, ViewRecordHelper) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            // alert("Hii in base js");
            this.fields = Finnova.Utils.cloneDeep(this.options.fields);
