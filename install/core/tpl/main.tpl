<form id="nav">
    <div class="panel-body">
            ...
            <div class="col-md-12">
                <div align="center">
                    <div class="content-img">
                        <img class="devices" src="img/devices.png" alt="FinnovaCRM">
                    </div>
        ...
        <div class="cell cell-website pull-right" align="right">
            <a target="_blank" href="https://www.fincrm.net/documentation/administration/installation/" style="font-weight:600;">{$langs['labels']['Installation Guide']}</a>
        </div>
