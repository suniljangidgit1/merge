...
Finnova.define('views/admin/label-manager/edit', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.ajaxPostRequest('LabelManager/action/getScopeData', {
                ...
                this.scopeDataInitial = Finnova.Utils.cloneDeep(this.scopeData);
                this.wait(false);
            }.bind(this));
        },
        ...
        actionSave: function () {
            ...
            Finnova.Ui.notify(this.translate('saving', 'messages'));
        ...
        actionCancel: function () {
            this.scopeData = Finnova.Utils.cloneDeep(this.scopeDataInitial);
            this.dirtyLabelList = [];
            this.setConfirmLeaveOut(false);
