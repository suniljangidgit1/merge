...
Finnova.define('views/fields/attachment-multiple', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.sourceList = Finnova.Utils.clone(this.params.sourceList || []).filter(function (item) {
        ...
        getEditPreview: function (name, type, id) {
            ...
            if (~this.previewTypeList.indexOf(type)) {
                preview = '<img class="img-responsive img-thumbnail" style="position: absolute;left: 50%;top: 50%;height: 100%;width: auto;-webkit-transform: translate(-50%,-50%);-ms-transform: translate(-50%,-50%);transform: translate(-50%,-50%);" src="' + this.getImageUrl(id, 'small') + '" width="150" height="100" title="' + name + '">';
            }
        ...
        addAttachmentBox: function (name, type, id, link) {
            ...
            var removeLink = '<a href="javascript:" class="remove-attachment pull-right"><span class="material-icons-outlined">close</span></a>';
            ...
            var $att = $('<div class="thumbnail">').addClass('gray-box')
                                 .append(removeLink)
            ...
            /*Added height and width to img and text file while uploading files start*/
            
            var taskClassName = $(".gray-box .preview img").attr('class');

            if(taskClassName == 'img-responsive img-thumbnail')
                {
                $(".gray-box .preview img").closest(".preview").addClass('gray-box-name');
                }

            /*Added height and width to img and text file while uploading files end*/
            if (!id) {
        ...
        getDetailPreview: function (name, type, id) {
            ...
            if (this.isTypeIsImage(type)) {
                preview = '<a data-action="showImagePreview" data-id="' + id + '" href="' + this.getImageUrl(id) + '"><img src="'+this.getImageUrl(id, this.previewSize)+'" class="image-preview img-responsive" width="80" height="70"></a>';
            }
            return preview;
        },
