...
<html>
 ...
 <script>
  ...
  <body >
	...
	$folderName= $_SESSION['subFolderName'];
  ...
  include($_SERVER['DOCUMENT_ROOT'].'/task_cron/subdomain_connection.php');
		...
		$resForCheckFolderName= mysqli_query($conn, "SELECT * FROM sub_folder_master_3 WHERE folder_name='".$folderName."' AND folder_master_id='".$_SESSION['subFolderID']."'");
		...
		$result_rename=mysqli_query($conn, "INSERT INTO sub_folder_master_3(folder_master_id,folder_name, created_user_id, assigned_user_id, defineAccess) VALUES (".$_SESSION['subFolderID'].",'".$folderName."', '".$createdBy."', '".$assignUser."', '".$userAccess."')");
       ...
       <script>
            ...
            buttons: {
                ok: function () {
                    window.location.href='viewFolderFiles.php?id=<?php echo $_SESSION['subFolderID']; ?>';
                }
            }
        });
        </script>
