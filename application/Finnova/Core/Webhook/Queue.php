...
use Finnova\Core\Utils\DateTime;
use Finnova\Entities\WebhookQueueItem;
use Finnova\Entities\Webhook;
...
class Queue
{
    ...
    public function __construct(
        ...
        \Finnova\Core\AclManager $aclManager
    ) {
        $this->sender = $sender;
        $this->config = $config;
    ...
    protected function createQueueFromEvent(\Finnova\Entities\WebhookEventQueueItem $item)
    {
