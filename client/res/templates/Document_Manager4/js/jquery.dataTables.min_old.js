...
(function(h) {
    ...
    function qb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="' + b.sFilterInput + '"/><span class="input-group-addon search-addon"><i class="fa fa-search" aria-hidden="true"></i></span>',
            j = d.sSearch,
    ...
    function pb(a) {
        for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f =
                e ? d[0] : d, d = e ? d[1] : d, e = h("<select  id='data_no' style='padding: 4px;border-color: #ddd;'/>", {
                    name: c + "_length",
                    "aria-controls": c,
