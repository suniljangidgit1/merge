...
Finnova.define('views/notification/items/assign', 'views/notification/items/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.messageData['entityType'] = Finnova.Utils.upperCaseFirst((this.translate(data.entityType, 'scopeNames') || '').toLowerCase());
