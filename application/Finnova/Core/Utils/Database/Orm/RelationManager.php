...
class RelationManager
{
    ...
    public function __construct(\Finnova\Core\Utils\Metadata $metadata)
    {
    ...
    protected function getRelationClass($relationName)
    {
        ...
        $className = '\Finnova\Custom\Core\Utils\Database\Orm\Relations\\'.$relationName;
        if (!class_exists($className)) {
            $className = '\Finnova\Core\Utils\Database\Orm\Relations\\'.$relationName;
        }
