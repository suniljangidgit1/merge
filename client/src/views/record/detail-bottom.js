...
define('views/record/detail-bottom', 'views/record/panels-container', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupPanels: function () {
            ...
            this.panelList = Finnova.Utils.clone(this.getMetadata().get('clientDefs.' + scope + '.bottomPanels.' + this.type) || this.panelList || []);
