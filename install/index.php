...
$ignoredFields = array('installProcess','domainName', 'dbName', 'hostName', 'dbUserName', 'dbUserPass', 'dbDriver');
...
$sanitizedLangs = \Finnova\Core\Utils\Util::sanitizeHtml($langs);
...
$systemConfig = include('application/Finnova/Core/defaults/systemConfig.php');
...
if (!empty($actionFile) && file_exists('install/core/tpl/'.$tplName)) {
	/*check if FinnovaCRM is built*/
	$isBuilt = file_exists('client/finnova.min.js');
