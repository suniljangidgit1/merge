...
use \Finnova\Core\Exceptions\Error,
    \Finnova\Core\Exceptions\Forbidden,
    \Finnova\Core\Exceptions\BadRequest;

class Activities extends \Finnova\Core\Controllers\Base
{
    ...
    public function getActionEntityTypeList($params, $data, $request)
    {
        ...
        \Finnova\Core\Utils\ControllerUtil::fetchListParamsFromRequest($params, $request, $data);
