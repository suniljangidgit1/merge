    ...
    <div class="page">
      ...
      <section class="dashboard-header section-padding">
        <div class="container-fluid">
          ...
          <div class="row mb-3">
            <div class="col-6" >
             <h3 class="text-left">Audio Files List</h3>
            </div>
...
<?php
   ...
   //get connection
    include($_SERVER['DOCUMENT_ROOT'].'/task_cron/subdomain_connection.php');
				...
				$query2 = "
			SELECT * FROM document_master_3 WHERE document_type='mp3' OR document_type='MP3' OR document_type='msv'";
		...
		?>
            <tr>
                ...
                <td title="<?php echo $row['document_name']; ?>"><img src="icon/audioicon.png" width="30" height="30" alt="Audio icon" title="No Audio Icon"><?php echo $row['document_name']; ?></td>
				...
				<td style="overflow:inherit"><div class="dropdown">
								  ...
								  <div class="dropdown-menu">
								    ...
								    <a href="#" class="dropdown-item btnaudiodelete" data-deleteaudio-id='<?php echo $idForcheckBox ?>'>Delete</a>
								  </div>
								</div>
						</td>
          ...
          $userLName1= $rowForUserName1['last_name'];	
								?>
									<tr>
										...
										<td title="<?php echo $row_user["document_name"];?>" ><img src="icon/audioicon.png" width="30" height="30" alt="No Image Icon" title="Image">&nbsp;&nbsp;<?php echo $row_user["document_name"];?></td>
							...
							<td style="overflow:inherit"><div class="dropdown">
								  ...
								  <div class="dropdown-menu">
								    ...
								    <a  class="dropdown-item" onclick="renameFile(' <?php echo $row_user['id'] ?>')" href="#">Rename</a>
								    <a  class="dropdown-item" onclick="shareSingleFileOrFolder('<?php echo $row['id']; ?>')" href="#">Share</a>
								    <a href="#" class="dropdown-item btnaudiodelete" data-deleteaudio-id=<?php echo $row_user['id'];?>>Delete</a>
								  </div>
								</div>
						</td>
                  ...
                  <div class="col-12 col-xs-12 col-sm-12 col-md-12 main">
                    ...
                    <!--   <form action="" method="post"> -->
                        <input type="hidden" name="usercount" id="inputcountusers">
                          ...
                          <div class="row">
                            <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                              <button class="btn btn-default form-control" id="extraassigniser" onclick="saveRename()" name="editfolder" style="color:#0f243f;">Save Changes</button>
                            </div>
...
<div class="modal" id="ShareViewAudioModal">
  <div class="modal-dialog">
    <div class="modal-content">
