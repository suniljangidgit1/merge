...
namespace Finnova\Core\Utils\Database\Schema\rebuildActions;

class FulltextIndex extends \Finnova\Core\Utils\Database\Schema\BaseRebuildActions
{
    public function beforeRebuild()
    {
        ...
        $databaseHelper = new \Finnova\Core\Utils\Database\Helper($this->getConfig());
