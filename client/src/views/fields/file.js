...
Finnova.define('views/fields/file', 'views/fields/link', function (Dep) {
    ...
    return Dep.extend({
        ...
        getDetailPreview: function (name, type, id) {
            ...
            if (~this.previewTypeList.indexOf(type)) {
                preview = '<a data-action="showImagePreview" data-id="' + id + '" href="' + this.getImageUrl(id) + '"><img class="img-responsive" width="80" height="70" src="'+this.getBasePath()+'?entryPoint=image&size='+this.previewSize+'&id=' + id + '" class="image-preview"></a>';
            }
            return preview;
        },
        ...
        getEditPreview: function (name, type, id) {
            ...
            if (~this.previewTypeList.indexOf(type)) {
                preview = '<img class="img-responsive" width="80" height="70" src="' + this.getImageUrl(id, 'small') + '" title="' + name + '">';
            }
