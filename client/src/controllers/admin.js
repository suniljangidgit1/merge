...
define('controllers/admin', ['controller', 'search-manager'], function (Dep, SearchManager) {
    ...
    return Dep.extend({
        ...
        rebuild: function (options) {
            ...
            Finnova.Ui.notify(master.translate('pleaseWait', 'messages'));

            Finnova.Ajax.postRequest('Admin/rebuild')
                .then(function () {
                    var msg = master.translate('Rebuild has been done', 'labels', 'Admin');
                    Finnova.Ui.success(msg);
        ...
        clearCache: function (options) {
            ...
            Finnova.Ajax.postRequest('Admin/clearCache')
                .then(function () {
