...
Finnova.define('crm:views/calendar/modals/edit', 'views/modals/edit', function (Dep) {
    ...
    return Dep.extend({
        ...
        createRecordView: function (model, callback) {
            var calender_popover = window.location.hash;
                if (calender_popover == '') {
                    this.notify(false);
                    return false;
                } else {
        ...
        setup: function () {
            this.scopeList = Finnova.Utils.clone(this.options.scopeList || this.scopeList);
