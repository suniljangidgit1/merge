...
$output .= '
<form name="comment_form" id="comment_form" class="comment_form" method="post" autocomplete="off">
		...
		<div class="panel-body">
			<div class="row button_section">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="hidden" class="form-control" name="estimate_id" id="estimate_id" value="'.$id.'" >
					</div>
				</div>
			</div>
			<div class="row button_section button_section_post">
				<div class="col-xs-5 col-md-1 clearfix" style="width:65px !important;">
				<button type="submit" id="user_feedback" value="" name="post" class="btn post_btn ">POST</button>
			</div>

			<div class="form-group reviewer_attach_section ">
				<div class="custom-file-upload ">
					<div class="feedback-custom-file-upload">
						<input type="file" name="feedback_attachment[]" id="feedback_attachment" class="form-control feedback_attachment" value="" multiple onchange="getFileInfo()" >
			...
			<div class="row">
				<div class="col-xs-12 col-md-6">
					<ul class="review_file list-unstyled clearfix"></ul>
				</div>
			</div>
		</div>
		<div class="form-group">
			<div>
				<div class="estimate_comments">
					<div class="list-container"><div class="list list-expanded"><ul class="list-group feedback_existing_append "></ul></div></div>
				</div>
			</div>
		</div>
	</div>	
