...
define('ui', [], function () {
    ...
    var Ui = Finnova.Ui = Finnova.ui = {
        ...
        warning: function (message) {
            Finnova.Ui.notify(message, 'warning', 2000);
        },

        success: function (message) {
            Finnova.Ui.notify(message, 'success', 2000);
        },

        error: function (message) {
            Finnova.Ui.notify(message, 'error', 2000);
        },

        info: function (message) {
            Finnova.Ui.notify(message, 'info', 2000);
        },
    }
