    ...
    <div class="page">
      ...
      <section class="dashboard-header section-padding">
        <div class="container-fluid">
          ...
          <div class="row mb-3" >
             <div class="col-md-6" >
                <h3 class="text-left">Video Files List</h3>
            </div>
...
<?php
	...
	{ ?>
		...
		<table id="example" class="display pictable">
        <thead>
            <tr>
		...
		<?php
				...
				$query2 = "
			SELECT * FROM document_master_3 WHERE document_type='mp4' OR document_type='MP4' OR document_type='AVI' OR document_type='avi' OR document_type='Mpg' OR document_type='mpg' OR document_type='wmv' OR document_type='3GP' OR document_type='gif' OR document_type='asf'";
		...
		?>
            <tr>
                ...
                <td title="<?php echo $row['document_name']; ?>"><img src="icon/video-icon.png" width="30" height="30" alt="Audio icon" title="No Audio Icon"><?php echo $row['document_name']; ?></td>
              ...
              <td style="overflow:inherit"><div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a href="#" class="dropdown-item btnvideodelete" data-deletevideo-id='<?php echo $idForcheckBox ?>'>Delete</a>
                  </div>
                </div>
            </td>
            </tr>
			...
			while($row_user=mysqli_fetch_array($query2))
			{
				...
				if(in_array($username,$assign_array) || $row_user['created_user_id']==$username)
				{
					...
					$new_login_userdata=implode(",",$assign_array);						
								$resForUserName1= mysqli_query($conn, "select * from user where user_name= '".$row_user["created_user_id"]."'");
                ...
                $userLName1= $rowForUserName1['last_name'];
								?>
									<tr>	
										<td><input type="checkbox" name="checkboxlist" value="<?php echo $row_user['id']; ?>" onclick="getCheckBoxValue(<?php echo $row_user['id']; ?>)"></td>
										<td title="<?php echo $row_user["document_name"];?>"><img src="icon/video-icon.png" width="30" height="30" alt="No Image Icon" title="Image">&nbsp;&nbsp;<?php echo $row_user["document_name"];?></td>
										<td><?php echo $userFName1. " ".$userLName1;?></td>
										<td><?php echo date('Y-m-d H:i:s',strtotime($row_user["createdAt"])); ?></td>
										<td><?php echo number_format((float)$row_user["document_size"]/(1024*1024),2,'.',''); ?> MB</td>
              ...
              <td style="overflow:inherit"><div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a  class="dropdown-item" onclick="renameFile('<?php echo $row['id']; ?>')" href="#">Rename</a>
                    <a  class="dropdown-item" onclick="shareSingleFileOrFolder('<?php echo $row_user['id']; ?>')" href="#">Share</a>
                    <a href="#" class="dropdown-item btnvideodelete" data-deletevideo-id=<?php echo $row_user['id'];?>>Delete</a>
                  </div>
                </div>
            </td>
									</tr>
                      ...
                      <form action="" method="post">
                        <input type="hidden" name="usercount" id="inputcountusers">
                          <div class="row mb-3">
                            ...
                            <div class="col-12 col-xs-12 col-sm-12 col-md-12">
                              <input class="form-control" type="text" name="folderName" value="" id="folderOrFileName" >
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                              <button class="btn btn-default form-control" id="extraassigniser" type="button" value="Edit Folder" name="editfolder" onclick="saveRename()" style="color:#0f243f;">Save Changes</button>
                            </div>
...
<div class="modal" id="ShareViewVideoModal">
  <div class="modal-dialog">
    <div class="modal-content">
