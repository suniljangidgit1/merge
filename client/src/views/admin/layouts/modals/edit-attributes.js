...
Finnova.define('views/admin/layouts/modals/edit-attributes', ['views/modal', 'model'], function (Dep, Model) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            var attributeList = Finnova.Utils.clone(this.options.attributeList || []);
