...
Finnova.define('crm:views/knowledge-base-article/record/list-for-case', 'views/record/list', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionSendInEmail: function (data) {
            ...
            new Promise(
                ...
                Finnova.require('crm:knowledge-base-helper', function (Helper) {
