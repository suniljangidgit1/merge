...
use \Finnova\Core\Htmlizer\Htmlizer;

class Pdf extends \Finnova\Core\Services\Base
{
    ...
    protected function printEntity(Entity $entity, Entity $template, Htmlizer $htmlizer, \Finnova\Core\Pdf\Tcpdf $pdf)
    {
    ...
    public function generateMailMerge($entityType, $entityList, Entity $template, $name, $campaignId = null)
    {
        ...
        $pdf = new \Finnova\Core\Pdf\Tcpdf();
        ...
        $filename = \Finnova\Core\Utils\Util::sanitizeFileName($name) . '.pdf';
    ...
    public function massGenerate($entityType, $idList, $templateId, $checkAcl = false)
    {
        ...
        $filename = \Finnova\Core\Utils\Util::sanitizeFileName($entityTypeTranslated) . '.pdf';
    ...
    public function buildFromTemplate(Entity $entity, Entity $template, $displayInline = false)
    {
        ...
        if ($displayInline) {
            ...
            $name = \Finnova\Core\Utils\Util::sanitizeFileName($name);
            $fileName = $name . '.pdf';
