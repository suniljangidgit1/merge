...
define('utils', [], function () {
    ...
    var Utils = Finnova.utils = Finnova.Utils = {
        ...
        convert: function (string, p) {
            ...
            switch (p) {
                case 'c-h':
                case 'C-h':
                    result = Finnova.Utils.camelCaseToHyphen(string);
                    break;
                case 'h-c':
                    result = Finnova.Utils.hyphenToCamelCase(string);
                    break;
                case 'h-C':
                    result = Finnova.Utils.hyphenToUpperCamelCase(string);
                    break;
            }
            return result;
        },
        ...
        cloneDeep: function (data) {
            data = Finnova.Utils.clone(data);

            if (Finnova.Utils.isObject(data) || _.isArray(data)) {
                for (var i in data) {
        ...
        toDom: function (string) {
            return Finnova.Utils.convert(string, 'c-h').split('.').join('-');
        },
