...
Finnova.define('views/fields/link-multiple-with-columns', 'views/fields/link-multiple', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.columns = Finnova.Utils.cloneDeep(this.model.get(this.columnsName) || {});
            ...
            this.columnList.forEach(function (column) {
                if (column in columnsDefsInitial) {
                    this.columnsDefs[column] = Finnova.Utils.cloneDeep(columnsDefsInitial[column]);
                    return;
                }
        ...
        fetch: function () {
            ...
            data[this.columnsName] = Finnova.Utils.cloneDeep(this.columns);
            return data;
        },
