...
class ScheduledJob
{
     ...
     */
    private $paths = array(
        'corePath' => 'application/Finnova/Jobs',
        'modulePath' => 'application/Finnova/Modules/{*}/Jobs',
        'customPath' => 'custom/Finnova/Custom/{*}/Jobs',
    );
    ...
    public function __construct(\Finnova\Core\Container $container)
    {
        ...
        $this->systemUtil = new \Finnova\Core\Utils\System();
    }
    ...
    /**
     * Load scheduler classes. It loads from ...Jobs, ex. \Finnova\Jobs
     * @return null
     */
    ...
    public function isCronConfigured()
    {
        ...
        $format = \Finnova\Core\Utils\DateTime::$systemDateTimeFormat;
