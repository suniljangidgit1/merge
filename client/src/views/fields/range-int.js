...
Finnova.define('views/fields/range-int', ['views/fields/base', 'views/fields/int'], function (Dep, Int) {
    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            data.ucName = Finnova.Utils.upperCaseFirst(this.name);
        ...
        init: function () {
            var ucName = Finnova.Utils.upperCaseFirst(this.options.defs.name);
