...
Finnova.define('views/email-account/fields/folder', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        events: {
            'click [data-action="selectFolder"]': function () {
                ...
                Finnova.Ajax.postRequest('EmailAccount/action/getFolders', data).then(function (folders) {
                    ...
                    Finnova.Ui.error(this.translate('couldNotConnectToImap', 'messages', 'EmailAccount'));
