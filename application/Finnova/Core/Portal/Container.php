...
namespace Finnova\Core\Portal;

class Container extends \Finnova\Core\Container
{
    ...
    {
        $className = $this->getServiceClassName('aclManager', '\\Finnova\\Core\\Portal\\AclManager');
        $mainClassName = $this->getServiceMainClassName('aclManager', '\\Finnova\\Core\\AclManager');
    ...
    {
        $className = $this->getServiceClassName('acl', '\\Finnova\\Core\\Portal\\Acl');
    ...
    {
        return new \Finnova\Core\Portal\Utils\ThemeManager(
            $this->get('config'),
            $this->get('metadata'),
            $this->get('portal')
        );
    ...
    {
        return new \Finnova\Core\Portal\Utils\Layout(
    ...
    {
        $language = new \Finnova\Core\Portal\Utils\Language(
    ...
    public function setPortal(\Finnova\Entities\Portal $portal)
    {
