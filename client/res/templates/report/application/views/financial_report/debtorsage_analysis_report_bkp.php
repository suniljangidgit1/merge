               ...
               <div class="table-responsive">
               		...
               		<thead class="schedularth">
               			<tr>
               				<th>&nbsp;</th>
               				<th>&nbsp;</th>
               				<th colspan="3"><center><strong>Number Of Days Overdue</strong></center></th>
               				<th>&nbsp;</th>
               			</tr>
               			<tr>
               				<th></th>
               				<th style="text-align:right;"><span>Not Yet Overdue</span></th>
               				<th style="background-color:aliceblue;text-align:right;"><span>30 or less</span></th>
               				<th style="background-color:aliceblue;text-align:right;"><span>31 to 60</span></th>
               				<th style="background-color:aliceblue;text-align:right;"><span>61 to 90</span></th>
               				<th style="background-color:aliceblue;text-align:right;"><span>91 or more</span></th>
...
<?php if( !empty($invoiceArr) ) { ?>
	$(document).ready(function(){
		...
		$('input[name="ageanalysis_reportrange"]').on('apply.daterangepicker', function(ev, picker) {
			...
			$.ajax({
				...
				success 	: function(response){
					...
					$("#age_analysis_table").html(response.html);
		...
		$("#ageanalysis_reportrange").change(function(){
			...
			if( ageanalysis_reportrange != "" ){
				...
				$.ajax({
					...
					method		: 'POST',
					dataType	: "json",
					data		: { "ageanalysis_reportrange" : ageanalysis_reportrange, "reportType" : reportType, "reportStage" : reportStage, "teamId" : teamId, "userId" : userId },
					success 	: function(response){
