<?php
	session_start();
	error_reporting(0);
	$mainFolderId=$_GET['id'];
	$_SESSION['mainFolderId']=$mainFolderId;
...
<html>
	...
	<body>
		...
		<div class="col-sm-9 col-sm-offset-3 main" style="width:100%;">
			<div class="row">
				<form action="saveMainFolder.php" method="post">
					<table class="table" style="position:relative; left:150px; width:500px;">
						<tr>
							<th colspan="3" style="padding:20px;"><center><b style="font-weight:800; font-size:18px;">Create Folder</b></center></th>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" class="form-control" name="folderName" style="height:40px;"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<select name="user" class="form-control" style="height:40px;">
									...
									<?php
										...
										$result=mysqli_query($conn, "SELECT * FROM user where deleted='0'");
						...
						<tr>
							<td colspan="3">
								<input class="btn btn-primary form-control" type="submit" value="Create Folder"/>
							</td>
						</tr>
					</table>
				</form>
