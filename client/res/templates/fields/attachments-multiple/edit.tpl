    ...
    <div class="clearfix attachment-control">
        ...
        <div class="pull-left">
            <label class="attach-file-label" title="{{translate 'Attach File'}}">
                <span class="btn btn-default_gray btn-icon"><span class="fas fa-paperclip"></span></span>
        ...
        <div class="pull-left dropdown">
            <button class="btn btn-default_gray btn-icon dropdown-toggle" type="button" data-toggle="dropdown">
