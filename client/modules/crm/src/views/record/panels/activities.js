...
Finnova.define('crm:views/record/panels/activities', ['views/record/panels/relationship', 'multi-collection'], function (Dep, MultiCollection) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.listLayout = Finnova.Utils.cloneDeep(this.listLayout);
            this.actionList = Finnova.Utils.cloneDeep(this.actionList);
        ...
        getComposeEmailAttributes: function (scope, data, callback) {
            ...
            if (
                ...
                attributes.teamsIds = Finnova.Utils.clone(this.model.get('teamsIds'));
                attributes.teamsNames = Finnova.Utils.clone(this.model.get('teamsNames') || {});
