...
define('search-manager', [], function () {
    ...
    var SearchManager = function (collection, type, storage, dateTime, defaultData, emptyOnReset) {
        ...
        if (defaultData) {
            ...
            for (var p in this.emptyData) {
                if (!(p in defaultData)) {
                    defaultData[p] = Finnova.Utils.clone(this.emptyData[p]);
                }
            }
        }

        this.data = Finnova.Utils.clone(defaultData) || this.emptyData;
    ...
    _.extend(SearchManager.prototype, {
        ...
        loadStored: function () {
            this.data = this.storage.get(this.type + 'Search', this.scope) || Finnova.Utils.clone(this.defaultData) || Finnova.Utils.clone(this.emptyData);
            this.sanitizeData();
            return this;
        },
        ...
        setAdvanced: function (advanced) {
            this.data = Finnova.Utils.clone(this.data);
        ...
        empty: function () {
            this.data = Finnova.Utils.clone(this.emptyData);
            if (this.storage) {
        ...
        reset: function () {
            ...
            this.data = Finnova.Utils.clone(this.defaultData) || Finnova.Utils.clone(this.emptyData);
            if (this.storage) {
                this.storage.clear(this.type + 'Search', this.scope);
            }
        },
