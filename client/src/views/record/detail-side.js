...
define('views/record/detail-side', 'views/record/panels-container', function (Dep) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.panelList = Finnova.Utils.clone(this.panelList);
        ...
        setup: function () {
            ...
            this.panelList = this.panelList.filter(function (p) {
                ...
                if (p.accessDataList) {
                    if (!Finnova.Utils.checkAccessDataList(p.accessDataList, this.getAcl(), this.getUser())) {
                        return false;
                    }
                }
                return true;
            ...
            this.panelList = this.panelList.map(function (p) {
                var item = Finnova.Utils.clone(p);
            ...
            this.wait(
                Promise.all([
                    new Promise(
                        function (resolve) {
                            this.getHelper().layoutManager.get(this.scope, 'sidePanels' + Finnova.Utils.upperCaseFirst(this.type), function (layoutData) {
        ...
        setupDefaultPanel: function () {
            ...
            defaultPanelDefs = Finnova.Utils.cloneDeep(defaultPanelDefs);
