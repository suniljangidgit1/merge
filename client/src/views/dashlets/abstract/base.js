...
Finnova.define('views/dashlets/abstract/base', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.defaultOptions = Finnova.Utils.clone(this.defaultOptions);

            this.optionsFields = this.getMetadata().get(['dashlets', this.name, 'options', 'fields']) || this.optionsFields || {};
            this.optionsFields = Finnova.Utils.clone(this.optionsFields);

            this.setupDefaultOptions();

            var options = Finnova.Utils.cloneDeep(this.defaultOptions);
            ...
            this.actionList = Finnova.Utils.clone(this.actionList);
