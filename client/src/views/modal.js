...
define('views/modal', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.buttonList = Finnova.Utils.cloneDeep(this.buttonList);
            this.dropdownItemList = Finnova.Utils.cloneDeep(this.dropdownItemList);

            // TODO remove it as depricated
            this.buttons = Finnova.Utils.cloneDeep(this.buttons);
            ...
            this.on('render', function () {
                ...
                this.dialog = new Finnova.Ui.Dialog({
        ...
        getDialogButtonList: function () {
            ...
            this.buttons.forEach(function (item) {
                var o = Finnova.Utils.clone(item);
            ...
            this.buttonList.forEach(function (item) {
                ...
                o.onClick = o.onClick || (this['action' + Finnova.Utils.upperCaseFirst(o.name)] || function () {}).bind(this);
                buttonListExt.push(o);
            }, this);
