...
namespace Finnova\Hooks\Note;

use Finnova\ORM\Entity;

class Mentions extends \Finnova\Core\Hooks\Base
{
    ...
    protected function notifyAboutMention(Entity $entity, \Finnova\Entities\User $user, Entity $parent = null)
    {
