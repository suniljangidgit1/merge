...
$len=count($_REQUEST['quantity_convert']);
...
{ 
    ...
    {
        $estimate_discount_amount_invoice=$_REQUEST['estimate_discount_amount_convert'];
        $estimate_discount_option_invoice=$_REQUEST['estimate_discount_option_convert'];
