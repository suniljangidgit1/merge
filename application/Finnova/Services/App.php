...
class App extends \Finnova\Core\Services\Base
{
    ...
    public function getUserData()
    {
        ...
        $language = \Finnova\Core\Utils\Language::detectLanguage($this->getConfig(), $this->getPreferences());
        ...
        return [
            ...
            'appParams' => [
                ...
                'passwordChangeForNonAdminDisabled' => $this->getConfig()->get('authenticationMethod', 'Finnova') !== 'Finnova',
    ...
    public function jobPopulateArrayValues()
    {
        ...
        foreach ($scopeList as $scope) {
            ...
            foreach ($seed->getAttributes() as $attribute => $defs) {
                if (!isset($defs['type']) || $defs['type'] !== \Finnova\ORM\Entity::JSON_ARRAY) continue;
