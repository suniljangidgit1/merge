...
define('dynamic-logic', [], function () {
    ...
    _.extend(DynamicLogic.prototype, {
        ...
        process: function () {
            ...
            Object.keys(fields).forEach(function (field) {
                ...
                this.fieldTypeList.forEach(function (type) {
                    ...
                    var methodName;
                    if (result) {
                        methodName = 'makeField' + Finnova.Utils.upperCaseFirst(type) + 'True';
                    } else {
                        methodName = 'makeField' + Finnova.Utils.upperCaseFirst(type) + 'False';
                    }
        ...
        processPanel: function (panel, type) {
            ...
            var methodName;
            if (result) {
                methodName = 'makePanel' + Finnova.Utils.upperCaseFirst(type) + 'True';
            } else {
                methodName = 'makePanel' + Finnova.Utils.upperCaseFirst(type) + 'False';
            }
