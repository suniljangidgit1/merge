...
class Team extends Record
{
	...
	include('application/Finnova/Core/Utils/myconfig.php');
        ...
        $this->getFileManager()->removeInDir('data/cache/'.$cacheDataPath.'/application/acl');
    }
	...
	include('application/Finnova/Core/Utils/myconfig.php');
        if ($link === 'users') {
            $this->getFileManager()->removeFile('data/cache/'.$cacheDataPath.'/application/acl/' . $foreignId . '.php');
        }
