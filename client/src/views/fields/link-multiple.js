...
Finnova.define('views/fields/link-multiple', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            if (this.mode == 'search') {
                ...
                this.nameHash = Finnova.Utils.clone(nameHash);
                this.ids = Finnova.Utils.clone(idList);
            } else {
        ...
        copyValuesFromModel: function () {
            this.ids = Finnova.Utils.clone(this.model.get(this.idsName) || []);
            this.nameHash = Finnova.Utils.clone(this.model.get(this.nameHashName) || {});
        },
