...
$username = ""; $password = 'd41d8cd98f00b204e9800998ecf8427e';
    ...
    $useruploadfolder = "epsyclinic/Uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "epsyclinic/Uploads";
        

    $useruploadfolder = "epsyclinic/UploadImages/ImageArtical";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "epsyclinic/UploadImages/ImageArtical";
