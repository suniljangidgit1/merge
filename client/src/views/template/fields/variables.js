 ...
 ************************************************************************/
Finnova.define('views/template/fields/variables', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupAttributeList: function () {
            ...
            var forbiddenList = Finnova.Utils.clone(this.getAcl().getScopeForbiddenAttributeList(entityType));
            ...
            linkList.forEach(function (link) {
                ...
                var forbiddenList = Finnova.Utils.clone(this.getAcl().getScopeForbiddenAttributeList(scope));
