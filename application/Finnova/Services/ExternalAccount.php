...
class ExternalAccount extends Record
{
    ...
    protected function getClient($integration, $id)
    {
        ...
        $factory = new \Finnova\Core\ExternalAccount\ClientManager($this->getEntityManager(), $this->getMetadata(), $this->getConfig());
    ...
    public function authorizationCode($integration, $userId, $code)
    {
        ...
        $client = $this->getClient($integration, $userId);
        if ($client instanceof \Finnova\Core\ExternalAccount\Clients\OAuth2Abstract) {
