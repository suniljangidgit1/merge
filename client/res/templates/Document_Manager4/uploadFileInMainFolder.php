...
<html>
	...
	<body>
		...
		<div class="col-sm-9 col-sm-offset-3 main" style="position:relative; left:150px; top:60px; width:100%;">
			<div class="row">
				<form action="upload_file_outsidefolder.php" method="post" enctype="multipart/form-data">
					<table class="table" style="width:480px;">
						<tr>
							<th colspan="3" style="padding:20px;"><center><b style="font-weight:800; font-size:18px;">Upload File</b></center></th>
						</tr>
						<tr>
							<td>
