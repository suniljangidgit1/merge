...
class Admin extends \Finnova\Core\Controllers\Base
{
    ...
    public function postActionUploadUpgradePackage($params, $data)
    {
        ...
        $upgradeManager = new \Finnova\Core\UpgradeManager($this->getContainer());
    ...
    {
        $adminNotificationManager = new \Finnova\Core\Utils\AdminNotificationManager($this->getContainer());
        return $adminNotificationManager->getNotificationList();
    }

    public function actionSystemRequirementList($params)
    {
        $systemRequirementManager = new \Finnova\Core\Utils\SystemRequirements($this->getContainer());
