...
Finnova.define('views/fields/phone', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            var phoneNumberData;
            if (this.mode == 'edit') {
                phoneNumberData = Finnova.Utils.cloneDeep(this.model.get(this.dataFieldName));
            ...
            if (phoneNumberData) {
                phoneNumberData = Finnova.Utils.cloneDeep(phoneNumberData);
        ...
        events: {
            ...
            'click [data-action="addPhoneNumber"]': function () {
                var data = Finnova.Utils.cloneDeep(this.fetchPhoneNumberData());
