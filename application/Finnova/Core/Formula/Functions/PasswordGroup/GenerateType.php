...
namespace Finnova\Core\Formula\Functions\PasswordGroup;

use \Finnova\ORM\Entity;
use \Finnova\Core\Exceptions\Error;

class GenerateType extends \Finnova\Core\Formula\Functions\Base
{
    ...
    public function process(\StdClass $item)
    {
        ...
        $password = \Finnova\Core\Utils\Util::generatePassword($length, $letterCount, $numberCount, true);
