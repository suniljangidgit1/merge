    ...
    <form id="nav">
        <div class="row">
            ...
            <div class="cell cell-website pull-right" align="right">
                <a target="_blank" href="https://www.fincrm.net/documentation/administration/server-configuration/" style="font-weight:600;">{$langs['labels']['Configuration Instructions']}</a>
            </div>
        </div>
    </form>
    <div class="space"></div>
